...
module SerializationWithGlobalizeTranslations #:nodoc:
...
ActiveRecord::AttributeMethods::Serialization::ClassMethods.send(:prepend, AttributeComputeTypeWithTranslations)